                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false"
                                data-target="#submenu-1" aria-controls="submenu-1"><i
                                    class="fa fa-fw fa-user-circle"></i>Category <span
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-2" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('createSubcategory') }}">Add New</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-3" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('createBrand') }}">Add New</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item ">
                            ...
                            <div id="submenu-4" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('createSlider') }}">Add New</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-5" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('productCreate') }}">Add New</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/product">List</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('stockCreate') }}">Add Stock</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div id="submenu-6" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('getOrder') }}">All Order</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('getReturn') }}">All Return</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
